...
- item: Nome do material ou serviço. ATENÇÃO: Se o relato incluir especificações como tamanho, cor, espessura ou modelo (ex: "canos de 1m"), junte essa característica ao nome do item (ex: registre como "Cano 1m" em vez de apenas "Cano").
